...
public class Contents extends YouTubeFailureRecoveryActivity implements YouTubePlayer.OnFullscreenListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (YouTubeId.contains("embed/"))
			YouTubeId = YouTubeId.substring(YouTubeId.indexOf("embed/") + "embed/".length());
